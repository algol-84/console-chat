...
//go:generate minimock -i github.com/algol-84/auth/internal/repository.AuthRepository -o auth_repository_minimock.go -n AuthRepositoryMock -p mocks
...
import (
	...
	mm_repository "github.com/algol-84/auth/internal/repository"
...
type AuthRepositoryMock struct {
	...
	funcGet          func(ctx context.Context, filter *mm_repository.Filter) (up1 *model.User, err error)
	funcGetOrigin    string
	inspectFuncGet   func(ctx context.Context, filter *mm_repository.Filter)
...
func (mmCreate *mAuthRepositoryMockCreate) Expect(ctx context.Context, user *model.User) *mAuthRepositoryMockCreate {
...
func (mmCreate *mAuthRepositoryMockCreate) ExpectUserParam2(user *model.User) *mAuthRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mAuthRepositoryMockCreate) Inspect(f func(ctx context.Context, user *model.User)) *mAuthRepositoryMockCreate {
...
func (mmCreate *mAuthRepositoryMockCreate) Set(f func(ctx context.Context, user *model.User) (i1 int64, err error)) *AuthRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthRepositoryMockCreate) When(ctx context.Context, user *model.User) *AuthRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *AuthRepositoryMock) Create(ctx context.Context, user *model.User) (i1 int64, err error) {
...
func (mmGet *mAuthRepositoryMockGet) Expect(ctx context.Context, filter *mm_repository.Filter) *mAuthRepositoryMockGet {
	...
	mmGet.defaultExpectation.params = &AuthRepositoryMockGetParams{ctx, filter}
...
// ExpectFilterParam2 sets up expected param filter for AuthRepository.Get
func (mmGet *mAuthRepositoryMockGet) ExpectFilterParam2(filter *mm_repository.Filter) *mAuthRepositoryMockGet {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("AuthRepositoryMock.Get mock is already set by Set")
	}
...
func (mmGet *mAuthRepositoryMockGet) Inspect(f func(ctx context.Context, filter *mm_repository.Filter)) *mAuthRepositoryMockGet {
...
func (mmGet *mAuthRepositoryMockGet) Set(f func(ctx context.Context, filter *mm_repository.Filter) (up1 *model.User, err error)) *AuthRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
// Then helper
func (mmGet *mAuthRepositoryMockGet) When(ctx context.Context, filter *mm_repository.Filter) *AuthRepositoryMockGetExpectation {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("AuthRepositoryMock.Get mock is already set by Set")
	}
	...
	expectation := &AuthRepositoryMockGetExpectation{
		mock:               mmGet.mock,
		params:             &AuthRepositoryMockGetParams{ctx, filter},
...
func (mmGet *AuthRepositoryMock) Get(ctx context.Context, filter *mm_repository.Filter) (up1 *model.User, err error) {
	...
	mm_params := AuthRepositoryMockGetParams{ctx, filter}
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		mm_got := AuthRepositoryMockGetParams{ctx, filter}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.filter != nil && !minimock.Equal(*mm_want_ptrs.filter, mm_got.filter) {
				mmGet.t.Errorf("AuthRepositoryMock.Get got unexpected parameter filter, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmGet.t.Fatalf("Unexpected call to AuthRepositoryMock.Get. %v %v", ctx, filter)
	return
}
...
func (mmUpdate *mAuthRepositoryMockUpdate) Expect(ctx context.Context, user *model.UserUpdate) *mAuthRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &AuthRepositoryMockUpdateParams{ctx, user}
...
// ExpectUserParam2 sets up expected param user for AuthRepository.Update
func (mmUpdate *mAuthRepositoryMockUpdate) ExpectUserParam2(user *model.UserUpdate) *mAuthRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mAuthRepositoryMockUpdate) Inspect(f func(ctx context.Context, user *model.UserUpdate)) *mAuthRepositoryMockUpdate {
...
func (mmUpdate *mAuthRepositoryMockUpdate) Set(f func(ctx context.Context, user *model.UserUpdate) (err error)) *AuthRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthRepositoryMockUpdate) When(ctx context.Context, user *model.UserUpdate) *AuthRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &AuthRepositoryMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &AuthRepositoryMockUpdateParams{ctx, user},
...
func (mmUpdate *AuthRepositoryMock) Update(ctx context.Context, user *model.UserUpdate) (err error) {
	...
	mm_params := AuthRepositoryMockUpdateParams{ctx, user}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := AuthRepositoryMockUpdateParams{ctx, user}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.user != nil && !minimock.Equal(*mm_want_ptrs.user, mm_got.user) {
				mmUpdate.t.Errorf("AuthRepositoryMock.Update got unexpected parameter user, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmUpdate.t.Fatalf("Unexpected call to AuthRepositoryMock.Update. %v %v", ctx, user)
	return
}
