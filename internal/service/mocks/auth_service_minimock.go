...
//go:generate minimock -i github.com/algol-84/auth/internal/service.AuthService -o auth_service_minimock.go -n AuthServiceMock -p mocks
...
func (mmCreate *mAuthServiceMockCreate) ExpectUserParam2(user *model.User) *mAuthServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
...
// ExpectUserParam2 sets up expected param user for AuthService.Update
func (mmUpdate *mAuthServiceMockUpdate) ExpectUserParam2(user *model.UserUpdate) *mAuthServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *AuthServiceMock) Update(ctx context.Context, user *model.UserUpdate) (err error) {
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.user != nil && !minimock.Equal(*mm_want_ptrs.user, mm_got.user) {
				mmUpdate.t.Errorf("AuthServiceMock.Update got unexpected parameter user, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
