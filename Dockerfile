...
COPY . /github.com/algol/chat_server/source/
# Устанавливаем папку как рабочую директорию
WORKDIR /github.com/algol/chat_server/source/   
...
COPY --from=builder /github.com/algol/chat_server/source/bin/chat_server .
