...
type ChatV1Client interface {
	...
	ConnectChat(ctx context.Context, in *ConnectRequest, opts ...grpc.CallOption) (ChatV1_ConnectChatClient, error)
...
func (c *chatV1Client) ConnectChat(ctx context.Context, in *ConnectRequest, opts ...grpc.CallOption) (ChatV1_ConnectChatClient, error) {
...
type ChatV1Server interface {
	...
	ConnectChat(*ConnectRequest, ChatV1_ConnectChatServer) error
...
func (UnimplementedChatV1Server) ConnectChat(*ConnectRequest, ChatV1_ConnectChatServer) error {
